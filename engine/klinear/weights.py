"""Low-level readers for BF16 and mixed W4A16 safetensors checkpoints."""
...
def detect_checkpoint_kind(
    ...
    *,
    ...
    raise ValueError(
        "checkpoint index is neither the BF16 contract nor a paired W4A16 layout"
    )
